import{j as e,L as i,r as m}from"./index-BM8zKWHf.js";import{C as l}from"./Data-CWw1KKb-.js";import"./index-TK6Purwi.js";import"./index-Cyu_ye1Q.js";import"./index-4Nod0d8_.js";function c(t){const r=t.icon;return e.jsxs("li",{className:`flex gap-2 items-center cursor-pointer rounded-[7px] p-4 pr-8 w-full ${t.activeLink===t.title?"bg-[#0A1330] text-white":""}`,children:[e.jsx(r,{}),e.jsx(i,{onClick:()=>t.setActiveLink(t.title),className:"text-nowrap",to:t.to,children:t.title})]})}function f(){const[t,r]=m.useState("");return e.jsx(e.Fragment,{children:e.jsxs("div",{className:` border-[#343B4F] 
